...
import { getOpenSidebarFromLS, setOpenSidebarToLS } from '@/utils/storage'
...
function SidebarProvider({
  defaultOpen = getOpenSidebarFromLS(),
  open: openProp,
