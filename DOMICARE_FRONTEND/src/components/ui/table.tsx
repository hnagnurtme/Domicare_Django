...
function TableHeader({ className, ...props }: React.ComponentProps<'thead'>) {
  return <thead data-slot='table-header' className={cn('[&_tr]:border-b border-b-gray-100', className)} {...props} />
}
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot='table-row'
      className={cn(
        'hover:bg-gray-50 data-[state=selected]:bg-neutral-50 border-b border-b-gray-400 transition-colors dark:hover:bg-gray-800/50 dark:data-[state=selected]:bg-neutral-800',
        className
      )}
      {...props}
    />
